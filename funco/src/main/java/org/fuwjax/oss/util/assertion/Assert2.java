...
import static org.fuwjax.oss.util.assertion.Assertions.asserts;
import static org.fuwjax.oss.util.assertion.Assertions.fails;
import static org.fuwjax.oss.util.assertion.Assertions.failsToReturn;
import static org.fuwjax.oss.util.assertion.Assertions.failsToReturnWith;
import static org.fuwjax.oss.util.assertion.Assertions.failsWith;
import static org.fuwjax.oss.util.assertion.Assertions.isException;
import static org.fuwjax.oss.util.assertion.Assertions.isJustA;
import static org.fuwjax.oss.util.io.Files2.relativize;
import static org.fuwjax.oss.util.io.Files2.resolve;
