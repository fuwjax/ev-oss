...
/**
 * Manages the paths used by a stage during a Glid test execution. It's important that none of these methods return
 * null. They may throw an exception if they truly have no analog in the file system. They should be returned whether
 * they exist, it's simply where in the file system they would occur, regardless of whether they actually do.
 * @author fuwjax
 */
public interface Stage {
	/**
	 * The input path for the service.
	 * @param service the service name of one of the registered {@link ServiceProxy} instances
