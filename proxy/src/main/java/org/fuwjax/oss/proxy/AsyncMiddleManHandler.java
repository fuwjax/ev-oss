...
public class AsyncMiddleManHandler extends AbstractProxyHandler
{
    ...
    protected void service(HttpServletRequest clientRequest, HttpServletResponse proxyResponse) throws ServletException, IOException
    {
        String rewrittenTarget = rewriteTarget(clientRequest);
            _log.debug("{} rewriting: {} -> {}", getRequestId(clientRequest), Log.defer(()->{
    ...
    public static class Transparent extends ProxyHandler
    {
        ...
        public Transparent(ProxyConfig config) throws ServletException
        {
            super(config);
    ...
    {
        private final String WRITE_LISTENER_ATTRIBUTE = AsyncMiddleManHandler.class.getName() + ".writeListener";
